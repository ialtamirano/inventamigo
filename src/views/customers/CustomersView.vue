    ...
    <div class="level">
      <div class="level-left">
        <h1 class="title is-4 mb-2">
          <router-link :to="{ name: 'customers-list' }" class=""
            ><span class="has-text-primary">Clientes</span></router-link
          >
          / Perfil
        </h1>
      </div>
        ...
        <div class="media-content">
          <div class="content">
            <p>
              ...
              <small>{{ currentCustomer.email }}</small> <small>31m</small>
              <br />
                ...
                <address>
                  <address>
                    <a href="mailto:{{currentCustomer.email}}">{{
                      currentCustomer.primary_contact
                    }}</a
                    >.<br />
                    Direcci&oacute;n:<br />
                    Example.com<br />
      ...
      <form class="">
        <div class="field">
          <label class="label" for="code"
            >C&oacute;digo / Numero de cliente</label
          >
          <input
            type="text"
            class="input"
        ...
        <div class="field is-grouped">
          ...
          <p class="control">
            <button
              class="button is-light is-right mr-2"
